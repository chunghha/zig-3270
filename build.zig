...
pub fn build(b: *std.Build) void {
    ...
    // libghostty_vt is an optional dependency that provides terminal emulation
    // using real-world proven Ghostty terminal core. It's integrated via a
    ...
    if (b.lazyDependency("libghostty_vt", .{
        ...
        // Add libghostty-vt to visual test module as well
